...
namespace FblaQuizzerBusiness.Data
{
    ...
    {   
        ...
        private static TrueFalseQuestion GetTrueFalseQuestion(DbConnection cn, Guid id)
        {
        ...
        private static MultipleChoiceQuestion GetMultipleChoiceQuestion(DbConnection cn, Guid id)
        {
        ...
        private static TextQuestion GetTextQuestion(DbConnection cn, Guid id)
        {
        ...
        private static MatchingQuestion GetMatchingQuestion(DbConnection cn, Guid id)
        {
